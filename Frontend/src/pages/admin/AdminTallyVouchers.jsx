        ...
        <div className="p-3 sm:p-4 md:p-6 bg-slate-50 min-h-screen">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex items-center gap-3 mb-6 sm:mb-8">
                    ...
                    <div>
                        <h1 className="text-xl sm:text-3xl font-black text-slate-800 tracking-tight leading-tight">Sales Voucher</h1>
                        <p className="text-slate-500 font-bold uppercase tracking-widest text-[9px] sm:text-[10px]">Direct Tally Entry</p>
                    </div>
                </div>

                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">

                    {/* ── Top Grid: General Info + Summary ── */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">

                        {/* General Information */}
                        <div className="bg-white p-5 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 space-y-5 sm:space-y-6">
                            ...
                            <div>
                                ...
                                <select
                                    required
                                    className="w-full px-4 sm:px-6 py-3.5 sm:py-4 bg-slate-50 border-none rounded-2xl outline-none focus:ring-2 focus:ring-teal-500/20 font-bold text-slate-700 appearance-none text-sm"
                            ...
                            <div className="grid grid-cols-1 xs:grid-cols-2 gap-3 sm:gap-4">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        className="w-full px-4 sm:px-6 py-3.5 sm:py-4 bg-slate-50 border-none rounded-2xl outline-none focus:ring-2 focus:ring-teal-500/20 font-bold text-slate-700 text-sm"
                        ...
                        {/* Summary / Sync Card */}
                        <div className="bg-slate-900 p-5 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] shadow-2xl text-white flex flex-col justify-between gap-6">
                            <div>
                                <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-2 mb-6 sm:mb-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <button
                                    ...
                                    className={`w-full py-4 sm:py-5 rounded-2xl font-black uppercase tracking-widest text-xs sm:text-sm transition-all shadow-xl ${loading || !voucher.partyName
                    ...
                    {/* ── Inventory Items ── */}
                    <div className="bg-white p-5 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100">
                        <div className="flex items-center justify-between mb-6 sm:mb-8">
                            ...
                            <button
                                type="button"
                                onClick={addItem}
                                className="text-[10px] font-black uppercase tracking-widest text-teal-600 px-3 sm:px-4 py-2 bg-teal-50 rounded-lg hover:bg-teal-100 transition-all"
                            >
                                + Add Row
                            </button>
                        </div>
                        ...
                        <div className="space-y-3 sm:space-y-4">
                            {voucher.inventoryEntries.map((item, idx) => (
                                <div
                                    key={idx}
                                    className="bg-slate-50 p-3 sm:p-4 rounded-2xl sm:rounded-3xl border-2 border-transparent hover:border-teal-500/10 transition-all"
                                >
                                    {/* ── Desktop row (md+): grid-cols-12 ── */}
                                    <div className="hidden md:grid grid-cols-12 gap-3 lg:gap-4 items-end">
                                        <div className="col-span-5">
                                            <label className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1.5 block ml-1">Stock Item Name</label>
                                            <select
                                                required
                                                className="w-full px-4 py-3 bg-white border-none rounded-xl outline-none focus:ring-2 focus:ring-teal-500/20 font-bold text-slate-700 appearance-none text-sm"
                                                value={item.itemName}
                                        ...
                                        <div className="col-span-2">
                                            ...
                                            <input
                                                type="number"
                                                className="w-full px-4 py-3 bg-white border-none rounded-xl outline-none focus:ring-2 focus:ring-teal-500/20 font-bold text-slate-700 text-sm"
                                                value={item.quantity}
                                        ...
                                        <div className="col-span-2">
                                            ...
                                            <div className="w-full px-4 py-3 bg-white/50 border border-slate-100 rounded-xl font-bold text-slate-400 text-sm">
                                        ...
                                        <div className="flex items-center justify-between gap-3">
                                            ...
                                            <div className="pt-5">
                                                <button
                                                    type="button"
                                                    onClick={() => removeItem(idx)}
                                                    className="w-10 h-10 rounded-full flex items-center justify-center text-slate-300 hover:text-rose-500 hover:bg-rose-50 transition-all text-lg"
                                                >
                                                    &times;
                                                </button>
                                            </div>
